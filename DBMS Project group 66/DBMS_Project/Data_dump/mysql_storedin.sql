...
CREATE TABLE `storedin` (
  ...
  PRIMARY KEY (`wid`,`pid`),
  KEY `pid` (`pid`),
  CONSTRAINT `storedin_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `product` (`pid`),
  CONSTRAINT `storedin_ibfk_2` FOREIGN KEY (`wid`) REFERENCES `warehouse` (`WID`)
